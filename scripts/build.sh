#!/usr/bin/env bash
# Builds Vervellum.app from the command line and reveals it in Finder on success.
...
set -euo pipefail
export BUILD_APP_NAME="Vervellum"
export BUILD_KIND="xcode"
export BUILD_XCODE_PROJECT="Vervellum.xcodeproj"
export BUILD_XCODE_SCHEME="Vervellum"
